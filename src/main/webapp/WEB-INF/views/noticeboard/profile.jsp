					...
					<div class="card-body">
						<div class="tab-content">
							<div class="tab-pane active" id="settings">
								<form class="form-horizontal" action="/notice/profileUpdate.do" 
									method="post" id="profileUdtForm" enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="text-center">
											...
											src="${member.memProfileImg }" id="profileImg"
											alt="User profile picture" style="width: 150px;">
										</div>
									</div>
									<div class="form-group row">
										<label for="memProgileImg" class="col-sm-2 col-form-label"></label>
										<div class="col-md-10">
										<br>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											...
											placeholder="이름을 입력해주세요." value="${member.memName }">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											...
											placeholder="이메일을 입력해주세요." value="${member.memEmail }">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-10">
											...
											placeholder="전화번호를 입력해주세요." value="${member.memPhone }">
										</div>
									</div>
									<div class="input-group mb-3">
										...
										<div class="col-sm-10">
											<div class="input-group mb-3">
												...
												id="memPostCode" name="memPostCode" value="${member.memPostCode }">
											...
											<div class="input-group mb-3">
												...
												id="memAddress2" name="memAddress2" value="${member.memAddress2 }">
											</div>
										</div>
									</div>
									<div class="form-group row">
...
function isImageFile(file){
	...
	return ($.inArray(ext, ["jpg", "jpeg", "gif", "png"]) === 01) ? false : true;
}
